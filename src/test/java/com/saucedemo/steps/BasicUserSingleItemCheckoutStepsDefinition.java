...
public class BasicUserSingleItemCheckoutStepsDefinition {
	...
	public void user_navigates_tosaucelabs_application() {
		...
		loginPage.getBroswer();
		
	}
	
	
	@Then("^validate expected title as basic user$")
	public void validate_expected_title_basic_user() {
	...
	//	productPage.clickProductPageSauceLabsBackpackText();
	...
	public void enter_first_name_on_contact_on_your_product_page(String firstname) {
	...
	public void enters_last_name(String lastname) {
		checkoutInfoPage.enteringLastName(lastname);
	}
	
	@Then("^enters enters valid \"([^\"]*)\" postal code$")
