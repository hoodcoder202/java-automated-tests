...
public class DatabaseValidationMySQL {
	...
	private static final String DB_URL = "jdbc:mysql://localhost:3306/Clients";

	// Database username
	private static final String DB_USER = "root";

	// Database password
	private static final String DB_PASSWORD = "Peewee1198";
