...
public class ConfigurationReader {
	 ...
	 public static void getProperties() {
		 ...
		 try {
			 ...
			 InputStream input = new FileInputStream(projectPath + "\\Config\\dev_configuration.properties");
			 prop.load(input);
			 ...
			 RemoteGridExeution.setRemoteChrome = remoteChrome;
			 RemoteGridExeution.setRemoteFirefox = remoteFirefox;
			 RemoteGridExeution.setRemoteEdge = remoteEdge;
			 RemoteGridExeution.setRemoteStatus = isRemote;
			 ...
			 //set Edge key values per expected test page
