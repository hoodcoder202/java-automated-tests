...
Background:
  ...
  Scenario Outline: User signs in using test data from excel sheet
    ...
    And navigates to cart from redshirt product page
    ...
    And user enter valid zip code <zip_code> using data <zip_code_col> from excel sheet "sheet2"
    And clicks continue
    Then clicks finish
    Then user should see success message
    
    Examples: 
      | row_number  | column_number |pw_row_number|pw_column_number|first_name| fs_col   |last_name |last_name_col|zip_code_row| zip_code_col |
      | 1           |     0         | 1           | 1              |    1     |     2    |    3     |   1         |      1     |        4     |
      | 2           |     1         | 2           | 2              |    2     |     3    |    4     |   2         |      2     |        5     |
